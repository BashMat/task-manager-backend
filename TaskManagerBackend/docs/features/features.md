...
- `Tracking` – responsible for:
  - Managing tasks, events or lists of items which are represented as abstract `Tracking Log Entries` entities. 
`Tracking Log` describes a container for entries to be tracked.
